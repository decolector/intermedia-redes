...
class UserIsFollowedByInputSet(InputSet):
    ...
    def set_Count(self, value):
        ...
        """
        super(UserIsFollowedByInputSet, self)._set_input('Count', value)
    def set_Cursor(self, value):
        """
        Set the value of the Cursor input for this Choreo. ((optional, string) The "next cursor" used to retrieve the next page of results.)
        """
        super(UserIsFollowedByInputSet, self)._set_input('Cursor', value)
    def set_UserID(self, value):
        """
        Set the value of the UserID input for this Choreo. ((optional, string) Deprecated (retained for backward compatibility only).)
        """
