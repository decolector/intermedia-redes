...
class GetValues(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(GetValues, self).__init__(temboo_session, '/Library/Google/Sheets/GetValues')


    def new_input_set(self):
        return GetValuesInputSet()

    def _make_result_set(self, result, path):
        return GetValuesResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return GetValuesChoreographyExecution(session, exec_id, path)

class GetValuesInputSet(InputSet):
    """
    ...
    def set_AccessToken(self, value):
        ...
        """
        super(GetValuesInputSet, self)._set_input('AccessToken', value)
    def set_ClientID(self, value):
        """
        Set the value of the ClientID input for this Choreo. ((conditional, string) The Client ID provided by Google. Required unless providing a valid AccessToken.)
        """
        super(GetValuesInputSet, self)._set_input('ClientID', value)
    def set_ClientSecret(self, value):
        """
        Set the value of the ClientSecret input for this Choreo. ((conditional, string) The Client Secret provided by Google. Required unless providing a valid AccessToken.)
        """
        super(GetValuesInputSet, self)._set_input('ClientSecret', value)
    def set_DateTimeRenderOption(self, value):
        ...
        """
        super(GetValuesInputSet, self)._set_input('DateTimeRenderOption', value)
    def set_Fields(self, value):
        ...
        """
        super(GetValuesInputSet, self)._set_input('Fields', value)
    def set_MajorDimension(self, value):
        ...
        """
        super(GetValuesInputSet, self)._set_input('MajorDimension', value)
    def set_Range(self, value):
        ...
        """
        super(GetValuesInputSet, self)._set_input('Range', value)
    def set_RefreshToken(self, value):
        """
        Set the value of the RefreshToken input for this Choreo. ((conditional, string) An OAuth refresh token used to generate a new access token when the original token is expired. Required unless providing a valid AccessToken.)
        """
        super(GetValuesInputSet, self)._set_input('RefreshToken', value)
    def set_SpreadsheetID(self, value):
        ...
        """
        super(GetValuesInputSet, self)._set_input('SpreadsheetID', value)
    def set_ValueRenderOption(self, value):
        ...
        """
        super(GetValuesInputSet, self)._set_input('ValueRenderOption', value)

class GetValuesResultSet(ResultSet):
    """
...
class GetValuesChoreographyExecution(ChoreographyExecution):

    def _make_result_set(self, response, path):
        return GetValuesResultSet(response, path)
