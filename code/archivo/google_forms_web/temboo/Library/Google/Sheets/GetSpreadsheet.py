...
class GetSpreadsheet(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(GetSpreadsheet, self).__init__(temboo_session, '/Library/Google/Sheets/GetSpreadsheet')


    def new_input_set(self):
        return GetSpreadsheetInputSet()

    def _make_result_set(self, result, path):
        return GetSpreadsheetResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return GetSpreadsheetChoreographyExecution(session, exec_id, path)

class GetSpreadsheetInputSet(InputSet):
    """
    ...
    def set_AccessToken(self, value):
        ...
        """
        super(GetSpreadsheetInputSet, self)._set_input('AccessToken', value)
    def set_ClientID(self, value):
        """
        Set the value of the ClientID input for this Choreo. ((conditional, string) The Client ID provided by Google. Required unless providing a valid AccessToken.)
        """
        super(GetSpreadsheetInputSet, self)._set_input('ClientID', value)
    def set_ClientSecret(self, value):
        """
        Set the value of the ClientSecret input for this Choreo. ((conditional, string) The Client Secret provided by Google. Required unless providing a valid AccessToken.)
        """
        super(GetSpreadsheetInputSet, self)._set_input('ClientSecret', value)
    def set_Fields(self, value):
        ...
        """
        super(GetSpreadsheetInputSet, self)._set_input('Fields', value)
    def set_IncludeGridData(self, value):
        """
        Set the value of the IncludeGridData input for this Choreo. ((optional, boolean) Set to True if grid data should be returned.)
        """
        super(GetSpreadsheetInputSet, self)._set_input('IncludeGridData', value)
    def set_Ranges(self, value):
        ...
        """
        super(GetSpreadsheetInputSet, self)._set_input('Ranges', value)
    def set_RefreshToken(self, value):
        """
        Set the value of the RefreshToken input for this Choreo. ((conditional, string) An OAuth refresh token used to generate a new access token when the original token is expired. Required unless providing a valid AccessToken.)
        """
        super(GetSpreadsheetInputSet, self)._set_input('RefreshToken', value)
    def set_SpreadsheetID(self, value):
        ...
        """
        super(GetSpreadsheetInputSet, self)._set_input('SpreadsheetID', value)

class GetSpreadsheetResultSet(ResultSet):
    """
...
class GetSpreadsheetChoreographyExecution(ChoreographyExecution):

    def _make_result_set(self, response, path):
        return GetSpreadsheetResultSet(response, path)
