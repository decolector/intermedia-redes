...
class BatchUpdateValues(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(BatchUpdateValues, self).__init__(temboo_session, '/Library/Google/Sheets/BatchUpdateValues')


    def new_input_set(self):
        return BatchUpdateValuesInputSet()

    def _make_result_set(self, result, path):
        return BatchUpdateValuesResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return BatchUpdateValuesChoreographyExecution(session, exec_id, path)

class BatchUpdateValuesInputSet(InputSet):
    """
    ...
    def set_AccessToken(self, value):
        ...
        """
        super(BatchUpdateValuesInputSet, self)._set_input('AccessToken', value)
    def set_ClientID(self, value):
        """
        Set the value of the ClientID input for this Choreo. ((conditional, string) The Client ID provided by Google. Required unless providing a valid AccessToken.)
        """
        super(BatchUpdateValuesInputSet, self)._set_input('ClientID', value)
    def set_ClientSecret(self, value):
        """
        Set the value of the ClientSecret input for this Choreo. ((conditional, string) The Client Secret provided by Google. Required unless providing a valid AccessToken.)
        """
        super(BatchUpdateValuesInputSet, self)._set_input('ClientSecret', value)
    def set_Data(self, value):
        ...
        """
        super(BatchUpdateValuesInputSet, self)._set_input('Data', value)
    def set_Fields(self, value):
        ...
        """
        super(BatchUpdateValuesInputSet, self)._set_input('Fields', value)
    def set_RefreshToken(self, value):
        """
        Set the value of the RefreshToken input for this Choreo. ((conditional, string) An OAuth refresh token used to generate a new access token when the original token is expired. Required unless providing a valid AccessToken.)
        """
        super(BatchUpdateValuesInputSet, self)._set_input('RefreshToken', value)
    def set_SpreadsheetID(self, value):
        ...
        """
        super(BatchUpdateValuesInputSet, self)._set_input('SpreadsheetID', value)
    def set_ValueInputOption(self, value):
        ...
        """
        super(BatchUpdateValuesInputSet, self)._set_input('ValueInputOption', value)

class BatchUpdateValuesResultSet(ResultSet):
    """
...
class BatchUpdateValuesChoreographyExecution(ChoreographyExecution):

    def _make_result_set(self, response, path):
        return BatchUpdateValuesResultSet(response, path)
