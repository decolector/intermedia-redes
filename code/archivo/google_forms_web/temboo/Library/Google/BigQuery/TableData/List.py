...
class List(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(List, self).__init__(temboo_session, '/Library/Google/BigQuery/TableData/List')
...
class ListInputSet(InputSet):
    ...
    def set_DatasetID(self, value):
        ...
        """
        super(ListInputSet, self)._set_input('DatasetID', value)
    ...
    def set_ProjectID(self, value):
        ...
        """
        super(ListInputSet, self)._set_input('ProjectID', value)
    ...
    def set_StartIndex(self, value):
        ...
        """
        super(ListInputSet, self)._set_input('StartIndex', value)
    def set_TableID(self, value):
        ...
        """
        super(ListInputSet, self)._set_input('TableID', value)
