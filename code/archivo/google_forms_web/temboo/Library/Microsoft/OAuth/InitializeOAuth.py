...
class InitializeOAuth(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(InitializeOAuth, self).__init__(temboo_session, '/Library/Microsoft/OAuth/InitializeOAuth')
...
class InitializeOAuthInputSet(InputSet):
    ...
    def set_DomainHint(self, value):
        ...
        """
        super(InitializeOAuthInputSet, self)._set_input('DomainHint', value)
    ...
    def set_Prompt(self, value):
        ...
        """
        super(InitializeOAuthInputSet, self)._set_input('Prompt', value)
    def set_Resource(self, value):
        ...
        """
        super(InitializeOAuthInputSet, self)._set_input('Resource', value)
