...
class AddWorksheet(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(AddWorksheet, self).__init__(temboo_session, '/Library/Microsoft/Excel/Worksheet/AddWorksheet')
...
class AddWorksheetInputSet(InputSet):
    ...
    def set_ItemPath(self, value):
        ...
        """
        super(AddWorksheetInputSet, self)._set_input('ItemPath', value)
    ...
    def set_Worksheet(self, value):
        ...
        """
        super(AddWorksheetInputSet, self)._set_input('Worksheet', value)
