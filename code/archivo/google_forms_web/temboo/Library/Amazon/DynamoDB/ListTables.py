...
class ListTables(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(ListTables, self).__init__(temboo_session, '/Library/Amazon/DynamoDB/ListTables')
...
class ListTablesInputSet(InputSet):
    ...
    def set_AWSAccessKeyId(self, value):
        ...
        """
        super(ListTablesInputSet, self)._set_input('AWSAccessKeyId', value)
    def set_AWSSecretKeyId(self, value):
        """
        Set the value of the AWSSecretKeyId input for this Choreo. ((required, string) The Secret Key ID provided by Amazon Web Services.)
        """
        super(ListTablesInputSet, self)._set_input('AWSSecretKeyId', value)
    def set_ExclusiveStartTableName(self, value):
        """
        ...
        """
        super(ListTablesInputSet, self)._set_input('ExclusiveStartTableName', value)
    def set_Limit(self, value):
        ...
        """
        super(ListTablesInputSet, self)._set_input('Limit', value)
    def set_UserRegion(self, value):
        ...
        """
        super(ListTablesInputSet, self)._set_input('UserRegion', value)
