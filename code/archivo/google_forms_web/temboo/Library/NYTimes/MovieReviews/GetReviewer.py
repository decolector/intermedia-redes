...
class GetReviewer(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(GetReviewer, self).__init__(temboo_session, '/Library/NYTimes/MovieReviews/GetReviewer')
...
class GetReviewerInputSet(InputSet):
    ...
    def set_APIKey(self, value):
        ...
        """
        super(GetReviewerInputSet, self)._set_input('APIKey', value)
    def set_ResourceType(self, value):
        ...
        """
        super(GetReviewerInputSet, self)._set_input('ResourceType', value)
    def set_ResponseFormat(self, value):
        """
        Set the value of the ResponseFormat input for this Choreo. ((optional, string) The format that the response should be in. Valid values are: json (the default) and xml.)
        """
        super(GetReviewerInputSet, self)._set_input('ResponseFormat', value)
