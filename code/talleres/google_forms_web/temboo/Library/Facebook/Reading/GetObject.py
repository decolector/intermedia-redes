...
class GetObject(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(GetObject, self).__init__(temboo_session, '/Library/Facebook/Reading/GetObject')
...
class GetObjectInputSet(InputSet):
    ...
    def set_AccessToken(self, value):
        ...
        """
        super(GetObjectInputSet, self)._set_input('AccessToken', value)
    def set_Fields(self, value):
        """
        Set the value of the Fields input for this Choreo. ((optional, string) A comma separated list of fields to return (i.e. id,name).)
        """
        super(GetObjectInputSet, self)._set_input('Fields', value)
    def set_ObjectID(self, value):
        """
        Set the value of the ObjectID input for this Choreo. ((required, string) The id of a graph api object to retrieve.)
        """
        super(GetObjectInputSet, self)._set_input('ObjectID', value)
    def set_ResponseFormat(self, value):
        """
        Set the value of the ResponseFormat input for this Choreo. ((optional, string) The format that the response should be in. Can be set to xml or json. Defaults to json.)
        """
        super(GetObjectInputSet, self)._set_input('ResponseFormat', value)
