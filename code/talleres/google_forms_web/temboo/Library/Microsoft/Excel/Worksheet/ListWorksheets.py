...
class ListWorksheets(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(ListWorksheets, self).__init__(temboo_session, '/Library/Microsoft/Excel/Worksheet/ListWorksheets')


    def new_input_set(self):
        return ListWorksheetsInputSet()

    def _make_result_set(self, result, path):
        return ListWorksheetsResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return ListWorksheetsChoreographyExecution(session, exec_id, path)

class ListWorksheetsInputSet(InputSet):
    """
    ...
    def set_AccessToken(self, value):
        ...
        """
        super(ListWorksheetsInputSet, self)._set_input('AccessToken', value)
    def set_ClientID(self, value):
        ...
        """
        super(ListWorksheetsInputSet, self)._set_input('ClientID', value)
    def set_ClientSecret(self, value):
        ...
        """
        super(ListWorksheetsInputSet, self)._set_input('ClientSecret', value)
    def set_ItemPath(self, value):
        ...
        """
        super(ListWorksheetsInputSet, self)._set_input('ItemPath', value)
    def set_Password(self, value):
        ...
        """
        super(ListWorksheetsInputSet, self)._set_input('Password', value)
    ...
    def set_Username(self, value):
        ...
        """
        super(ListWorksheetsInputSet, self)._set_input('Username', value)

class ListWorksheetsResultSet(ResultSet):
    """
...
class ListWorksheetsChoreographyExecution(ChoreographyExecution):

    def _make_result_set(self, response, path):
        return ListWorksheetsResultSet(response, path)
