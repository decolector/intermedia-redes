...
class GetLastColumn(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(GetLastColumn, self).__init__(temboo_session, '/Library/Microsoft/Excel/Range/GetLastColumn')


    def new_input_set(self):
        return GetLastColumnInputSet()

    def _make_result_set(self, result, path):
        return GetLastColumnResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return GetLastColumnChoreographyExecution(session, exec_id, path)

class GetLastColumnInputSet(InputSet):
    """
    ...
    def set_AccessToken(self, value):
        ...
        """
        super(GetLastColumnInputSet, self)._set_input('AccessToken', value)
    def set_ClientID(self, value):
        ...
        """
        super(GetLastColumnInputSet, self)._set_input('ClientID', value)
    def set_ClientSecret(self, value):
        ...
        """
        super(GetLastColumnInputSet, self)._set_input('ClientSecret', value)
    def set_ItemPath(self, value):
        ...
        """
        super(GetLastColumnInputSet, self)._set_input('ItemPath', value)
    def set_Password(self, value):
        ...
        """
        super(GetLastColumnInputSet, self)._set_input('Password', value)
    def set_Range(self, value):
        """
        Set the value of the Range input for this Choreo. ((conditional, string) The cell range to consider (e.g. A1:C100).)
        """
        super(GetLastColumnInputSet, self)._set_input('Range', value)
    def set_Select(self, value):
        ...
        """
        super(GetLastColumnInputSet, self)._set_input('Select', value)
    def set_Username(self, value):
        ...
        """
        super(GetLastColumnInputSet, self)._set_input('Username', value)
    def set_Worksheet(self, value):
        ...
        """
        super(GetLastColumnInputSet, self)._set_input('Worksheet', value)

class GetLastColumnResultSet(ResultSet):
    """
...
class GetLastColumnChoreographyExecution(ChoreographyExecution):

    def _make_result_set(self, response, path):
        return GetLastColumnResultSet(response, path)
