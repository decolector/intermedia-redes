...
class GetLastRow(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(GetLastRow, self).__init__(temboo_session, '/Library/Microsoft/Excel/Range/GetLastRow')
...
class GetLastRowInputSet(InputSet):
    ...
    def set_ItemPath(self, value):
        ...
        """
        super(GetLastRowInputSet, self)._set_input('ItemPath', value)
    ...
    def set_Select(self, value):
        ...
        """
        super(GetLastRowInputSet, self)._set_input('Select', value)
    def set_Username(self, value):
        ...
        """
        super(GetLastRowInputSet, self)._set_input('Username', value)
    def set_Worksheet(self, value):
        ...
        """
        super(GetLastRowInputSet, self)._set_input('Worksheet', value)
