...
class SearchCalendarsByName(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(SearchCalendarsByName, self).__init__(temboo_session, '/Library/Google/Calendar/SearchCalendarsByName')
...
class SearchCalendarsByNameInputSet(InputSet):
    ...
    def set_AccessToken(self, value):
        ...
        """
        super(SearchCalendarsByNameInputSet, self)._set_input('AccessToken', value)
    def set_CalendarName(self, value):
        ...
        """
        super(SearchCalendarsByNameInputSet, self)._set_input('CalendarName', value)
    def set_ClientID(self, value):
        """
        Set the value of the ClientID input for this Choreo. ((conditional, string) The Client ID provided by Google. Required unless providing a valid AccessToken.)
        """
        super(SearchCalendarsByNameInputSet, self)._set_input('ClientID', value)
    def set_ClientSecret(self, value):
        """
        Set the value of the ClientSecret input for this Choreo. ((conditional, string) The Client Secret provided by Google. Required unless providing a valid AccessToken.)
        """
        super(SearchCalendarsByNameInputSet, self)._set_input('ClientSecret', value)
    def set_Count(self, value):
        ...
        """
        super(SearchCalendarsByNameInputSet, self)._set_input('Count', value)
    def set_MaxResults(self, value):
        ...
        """
        super(SearchCalendarsByNameInputSet, self)._set_input('MaxResults', value)
    def set_RefreshToken(self, value):
        """
        Set the value of the RefreshToken input for this Choreo. ((conditional, string) An OAuth Refresh Token used to generate a new access token when the original token is expired. Required unless providing a valid AccessToken.)
        """
        super(SearchCalendarsByNameInputSet, self)._set_input('RefreshToken', value)
