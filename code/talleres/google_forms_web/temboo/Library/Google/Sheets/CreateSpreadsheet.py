...
class CreateSpreadsheet(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(CreateSpreadsheet, self).__init__(temboo_session, '/Library/Google/Sheets/CreateSpreadsheet')
...
class CreateSpreadsheetInputSet(InputSet):
    ...
    def set_Fields(self, value):
        ...
        """
        super(CreateSpreadsheetInputSet, self)._set_input('Fields', value)
    def set_NamedRanges(self, value):
        """
        ...
        """
        super(CreateSpreadsheetInputSet, self)._set_input('NamedRanges', value)
    ...
    def set_Sheets(self, value):
        ...
        """
        super(CreateSpreadsheetInputSet, self)._set_input('Sheets', value)
    def set_SpreadsheetProperties(self, value):
        """
        ...
        """
        super(CreateSpreadsheetInputSet, self)._set_input('SpreadsheetProperties', value)
