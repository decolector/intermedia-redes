...
class GetLastRow(Choreography):
    ...
    def __init__(self, temboo_session):
        ...
        """
        super(GetLastRow, self).__init__(temboo_session, '/Library/Google/Sheets/GetLastRow')


    def new_input_set(self):
        return GetLastRowInputSet()

    def _make_result_set(self, result, path):
        return GetLastRowResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return GetLastRowChoreographyExecution(session, exec_id, path)

class GetLastRowInputSet(InputSet):
    """
    ...
    def set_AccessToken(self, value):
        ...
        """
        super(GetLastRowInputSet, self)._set_input('AccessToken', value)
    def set_ClientID(self, value):
        """
        Set the value of the ClientID input for this Choreo. ((conditional, string) The Client ID provided by Google. Required unless providing a valid AccessToken.)
        """
        super(GetLastRowInputSet, self)._set_input('ClientID', value)
    def set_ClientSecret(self, value):
        """
        Set the value of the ClientSecret input for this Choreo. ((conditional, string) The Client Secret provided by Google. Required unless providing a valid AccessToken.)
        """
        super(GetLastRowInputSet, self)._set_input('ClientSecret', value)
    def set_DateTimeRenderOption(self, value):
        ...
        """
        super(GetLastRowInputSet, self)._set_input('DateTimeRenderOption', value)
    def set_Fields(self, value):
        ...
        """
        super(GetLastRowInputSet, self)._set_input('Fields', value)
    def set_MaxColumn(self, value):
        ...
        """
        super(GetLastRowInputSet, self)._set_input('MaxColumn', value)
    def set_MinColumn(self, value):
        ...
        """
        super(GetLastRowInputSet, self)._set_input('MinColumn', value)
    def set_RefreshToken(self, value):
        """
        Set the value of the RefreshToken input for this Choreo. ((conditional, string) An OAuth refresh token used to generate a new access token when the original token is expired. Required unless providing a valid AccessToken.)
        """
        super(GetLastRowInputSet, self)._set_input('RefreshToken', value)
    def set_SheetName(self, value):
        """
        Set the value of the SheetName input for this Choreo. ((optional, string) The sheet name.)
        """
        super(GetLastRowInputSet, self)._set_input('SheetName', value)
    def set_SpreadsheetID(self, value):
        ...
        """
        super(GetLastRowInputSet, self)._set_input('SpreadsheetID', value)
    def set_ValueRenderOption(self, value):
        ...
        """
        super(GetLastRowInputSet, self)._set_input('ValueRenderOption', value)

class GetLastRowResultSet(ResultSet):
    """
...
class GetLastRowChoreographyExecution(ChoreographyExecution):

    def _make_result_set(self, response, path):
        return GetLastRowResultSet(response, path)
